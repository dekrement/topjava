...
<div class="jumbotron">
    <div class="container">
            ...
            <div class="col-sm-7">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <form method="post" action="meals" id="filter" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <label class="control-label col-sm-4" for="startTime">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input class="form-control" type="text" name="startDate" id="endDate">
                                </div>
                                <label class="control-label col-sm-4" for="endTime">
                    ...
                    <div class="panel-footer text-rigth">
                        <a onclick="clearFilter()" class="btn btn-danger"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
                        <a onclick="updateTable()" class="btn btn-primary"><span class="glyphicon glyphicon-filter" aria-hidden="true"></span></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <hr>
        <a onclick="add()" class="btn btn-info">
        ...
        <table class="table table-striped display" id="datatable">
            ...
            <c:forEach items="${meals}" var="meal">
                ...
                <tr class="${meal.exceed ? 'exceeded' : 'normal'}" id="${meal.id}">
                    ...
                    <td>${meal.calories}</td>
                    <td>
                        <a href="meals/update?id=${meal.id}" title="<spring:message code="common.update"/>">
                            <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                        </a>
                    </td>
                    <td>
                        <a class="delete" title="<spring:message code="common.delete"/>">
